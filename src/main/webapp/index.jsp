    ...
    <body>
          ...
          <table border="1">
            <td>
                ...
                <p>Nombre: Ever Mamani Mamani<p>
                <p>Carnet: 14157344 lp<p>
            </td>
        </table>
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td><a href="Inicio?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro que qeuiere eliminar ??'))">Eliminar</a></td>
            </tr>
            </c:forEach>
        </table>
    </body>
